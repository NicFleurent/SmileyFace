        ...
        <header>
            <nav class="navbar navbar-expand-lg fixed-top">
                <div class="container-fluid ">
                    ...
                    <div class="collapse navbar-collapse mb-2 mb-lg-0 align-items-center justify-content-end me-5" id="nav-menu">
                        <ul class="navbar-nav ">
                ...
                <div class="offcanvas-body">
                    <div class="card h-100 card-event">
                        ...
                        <div class="card-footer d-flex flex-row justify-content-center p-0">
                            ...
                            <button type="button" class="btn btn-danger btn-supprimer rounded-0 w-100 p-3 radius-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
