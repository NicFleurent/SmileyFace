                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="supprimerUsager.php?id=<?php echo $row['id'] ?>"><button id="confirmSupp" type="button" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
