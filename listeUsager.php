    ...
    <main class="container">
        ...
        ?>
                <table class="table align-middle">
                    <thead>
                        <tr>
                            <th scope="col" colspan="3">Nom d'usager</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-outline-dark" href="modifierUsager.php?id=<?php echo $row['id'] ?>">Modifier</a></td>
                                <td><button id="confirmSupp" type="button" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
