...
<?php
    ...
    ?>
        ...
        <div class="container d-flex flex-column justify-content-center align-items-center vh-100">
            <div class="container-fluid bg-ctr-bleu br-1rem text-white p-5">
                ...
                <form id="form" class="row g-3 needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="nom" name="nom" value="" placeholder="Nom de l'évènement" required>
                            <?php
                            if ($erreur == true) {
                            ?>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="departement" name="departement" value="" placeholder="Département" required>
                            <?php
                            if ($erreur == true) {
                            ?>
                                <div class="text-danger">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="image" name="image" value="" placeholder="Lien vers une image représentant l'évènement" required>
                            <?php
                            if ($erreur == true) {
                            ?>
                                <div class="text-danger">
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="lien" name="lien" value="" placeholder="Lien du site web de l'évènement" required>
                            <?php
                            if ($erreur == true) {
                            ?>
                                <div class="text-danger">
